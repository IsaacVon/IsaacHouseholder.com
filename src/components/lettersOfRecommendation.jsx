      ...
      <div className="lettersOfRecommendationContainer">
        ...
        <div className="lettersOfRecommendationBody">
          ...
          <p>
            ...
            from 2016-2019 as a Test Engineer and Vehicle Integration Engineer.
            During his time, he led the in house Material and Fastener Testing
            Lab. He successfully ran the lab smoothly, and he interfaced with
            all engineering departments very well. In this role, he also
            insourced testing saving $750,000 in outside testing. During his
            vehicle integration role, he worked with directors to push
            innovative ideas into our future vehicles. He also collaborated with
            teams of engineers to enable them to meet our strict targets
            established to create our luxury vehicle.
          </p>
          <p>
            Isaac is highly motivated, self-directed, and self-driven. He
            maintains a positive attitude in all situations and spreads
            enthusiasm to others. He routinely exceeded his responsibilities at
            Karma automotive, taking on new and additional responsibilities and
            went above and beyond to what was required to ensure the success of
            the company. Outside of work hours, he volunteered on weekends to
            work at Karma publicity events and the Karma Newport Beach
            dealership. In this capacity, he showed excellent people skills and
            was recognized by the Director sales for his efforts and ability to
            work with high net worth
          </p>
          <p>
            Based on his technical skills, people skills, and trustworthiness, I
            can confidently say that Isaac will be an asset to any company he
            works for. I would not hesitate to have him on any future team I
            led.
          </p>
          <p>Sincerely,</p>
        </div>
        ...
        <p className="lettersOfRecommendationTitle">CTO / Karma Automotive </p>
