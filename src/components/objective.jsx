  ...
  return (
    <div className="objectiveContainer">
      ...
      <p className="objectiveText">
        ...
        that I would be great at sales. After gaining technical industry
        experience, I am now going to steer my career in this direction because
        I am confident that things will go great and I will continue to love the
        work I do. I plan on moving to Kauai, Hawaii this year with my fiancé
